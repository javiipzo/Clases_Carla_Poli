...
text=(' Hola! ' ,nombre, ', encantado de conocerte')
print(text)
...
#Escribir un programa que pregunte al usuario por el número de horas trabajadas y el coste por hora, y calcule su sueldo.
'''
...
parejas2 = [[['Juan',35,'H'], ['Maria',28,'M'], [['Luis',2,'H'], ['Nuria',4,'M']], 7, 60000],
           [['Ruth',38,'M'], ['Pablo',35,'H'], [['Alma',8,'M']], 10, 50000],
           [['Irene',50,'M'], ['Alberto',52,'H'], [['Lucia',27,'M'], ['Carlota',23,'M']], 30, 90000],
           [['Carla',22,'M'], ['Rocio',24,'M'], [['Thor',1,'H']], 2, 65000],
           [['Jose',35,'H'], ['Santiago',37,'H'], None, 4, 30000]
           [['Juan',35,'H'], ['Maria',28,'M'], [['Luis',2,'H'], ['Nuria',4,'M']], 7, 60000],
           [['Ruth',38,'M'], ['Pablo',35,'H'], [['Alma',8,'M']], 10, 50000],
           [['Irene',50,'M'], ['Alberto',52,'H'], [['Lucia',27,'M'], ['Carlota',23,'M']], 30, 90000],
           [['Carla',22,'M'], ['Rocio',24,'M'], [['Thor',1,'H']], 2, 65000],
           [['Jose',35,'H'], ['Santiago',37,'H'], None, 4, 30000]
